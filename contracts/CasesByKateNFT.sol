...
contract CasesByKateNFT is Ownable, KIP17Full("Cases by Kate", "CASES"), KIP17Mintable, KIP17Burnable, KIP17Pausable {

    address public onChainDataContract;

    function setOnChainDataContract(address addr) onlyOwner external {
        onChainDataContract = addr;
    }
